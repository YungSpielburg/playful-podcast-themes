      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-muted-foreground hover:text-teal text-sm">Twitter</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-teal text-sm">Instagram</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-teal text-sm">LinkedIn</a></li>
              </ul>
            </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 sm:mt-0">
            <a href="#" className="text-muted-foreground hover:text-teal">
