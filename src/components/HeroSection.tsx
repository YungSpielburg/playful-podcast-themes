    ...
    <section className="relative min-h-screen pt-20 flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 relative">
          ...
          >
            {/* Background image positioned behind everything but visible */}
            ...
            <div className="aspect-square rounded-2xl bg-gradient-to-br from-coral/70 to-accent/70 shadow-xl overflow-hidden p-px artistic-border relative z-10">
              <div className="w-full h-full rounded-2xl glass-dark overflow-hidden flex items-center justify-center relative z-10">
                <div className="relative w-full h-full">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-32 h-32 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center">
                      <div className="w-24 h-24 rounded-full flex items-center justify-center cursor-pointer group">
                        <div className="absolute inset-0 flex items-center justify-center z-20 bg-black/10 rounded-full hover:bg-black/20 transition-all">
                          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white group-hover:scale-110 transition-transform">
