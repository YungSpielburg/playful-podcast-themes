                ...
                <div className="relative w-full h-full">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-32 h-32 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center">
                      <div 
                        className="w-24 h-24 rounded-full flex items-center justify-center animate-pulse-gentle shadow-neon"
                        style={{
                          backgroundImage: "url('/lovable-uploads/b9e13408-3a1a-40fd-a52d-73da34ecf92d.png')",
