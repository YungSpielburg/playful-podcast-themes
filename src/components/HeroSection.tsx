    ...
    <section className="relative min-h-screen pt-20 pb-10 flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
        <div className="flex-1 pt-10">
          ...
          <motion.h1 
            className="font-bodoni font-bold text-5xl md:text-6xl lg:text-7xl tracking-wide mb-6"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.1 }}
          >
            <span className="whitespace-nowrap">Give Your Podcast</span><br />
            A <span className="font-bodoni font-bold text-accent glow-accent">Signature</span><br />
