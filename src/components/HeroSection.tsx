  ...
  return (
    <section className="relative min-h-screen pt-20 pb-10 flex items-center overflow-hidden">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-64 h-64 bg-indigo-light/15 rounded-full filter blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
        <div className="flex-1 pt-10">
          ...
          >
            ...
            A <span className="font-anton text-indigo glow-accent">Signature</span><br />
            <span className="text-indigo glow-accent">Sound</span>
          </motion.h1>
