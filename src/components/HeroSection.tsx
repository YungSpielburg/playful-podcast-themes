  ...
  return (
    <section className="relative min-h-screen pt-20 pb-10 flex items-center overflow-hidden">
      <div className="absolute inset-0 -z-10">
        {/* Enhanced background elements with softer gradients that match the new dark green background */}
        ...
        {/* New soft red bursts with adjusted opacity to work with the new dark green background */}
