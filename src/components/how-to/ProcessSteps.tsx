  ...
  return (
    <div className="grid gap-16 mb-16">
      ...
      <ProcessStep icon={PenTool} title="Creative Exploration">
        <p className="font-gotham text-lg mb-4">The goal of this phase is to understand the <span className="text-accent font-bold">feeling</span> the host wants to invoke with their intro.</p>
      ...
      <ProcessStep icon={BookOpen} title="References">
        <p className="font-gotham text-lg mb-4">
          If they have direct references, make sure to get <span className="text-accent font-bold">extremely specific</span> about <span className="text-accent font-bold">exactly</span> what they like about each one.
        </p>
        <p className="font-gotham text-lg mb-4">
      ...
      <ProcessStep icon={Users} title="Songwriting Process">
        <p className="font-gotham text-lg mb-4">When it comes down to the actual song, I have two approaches: <span className="text-accent font-bold">Direct and Serendipitous</span>.</p>
        ...
        <p className="font-gotham text-lg mb-6">
          Sometimes hosts want to be less "on the nose" — either personality-wise or because the title of the show doesn't lend itself to that method. In that case, we turn to the <span className="text-accent font-bold">Serendipitous</span> method where we drill down into the essence of the show and genuinely write a song about it. It feels as though there is this incredible song that just so happens to exactly reflect the show's values.
        </p>
      ...
      <ProcessStep icon={UsersRound} title="Iterative Collaboration">
        ...
        <p className="font-gotham text-lg text-accent font-bold">This is iterative and collaborative — enjoy the process!</p>
      </ProcessStep>
    </div>
  );
};
