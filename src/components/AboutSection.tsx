      ...
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="artistic-card rounded-2xl p-8 space-y-4 h-full min-h-[250px] flex flex-col transition-all duration-300 hover:border-gold/60 hover:shadow-neon">
